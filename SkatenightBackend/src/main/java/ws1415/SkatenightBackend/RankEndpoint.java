...
public class RankEndpoint extends SkatenightServerEndpoint{
     ...
     */
    public BooleanWrapper passLeader(Rank rank, @Named("name") String groupName, @Named("newLeader") String newLeader, @Named("oldLeader") String oldLeader){
     ...
     * @return BooleanWrapper, eigene Klasse um boolean Werte zurück zu geben
     */
    public BooleanWrapper giveRank(Rank rank, @Named("name") String user, @Named("groupName") String groupName){
        if(rank == null){
            throw new NullPointerException("no rank submitted");
        }
        if(groupName == null ||groupName.isEmpty()){
