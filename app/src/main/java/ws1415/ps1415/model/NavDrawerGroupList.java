        ...
        public static final NavDrawerItem[] items = new NavDrawerItem[]{
                ...
                new NavDrawerItem() {
                    ...
                    public void onClick(AdapterView<?> parent, View view, int position, long id) {
                        Intent create_user_group_intent = new Intent(parent.getContext(), CreateUserGroupActivity.class);
                        create_user_group_intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT);
                        parent.getContext().startActivity(create_user_group_intent);
                    }
                },
