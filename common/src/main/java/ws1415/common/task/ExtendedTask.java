...
public abstract class ExtendedTask<Params, Progress, Result> extends AsyncTask<Params, Progress, Result> {
    ...
    /**
     * Wird in der {@link ws1415.common.task.ExtendedTask#doInBackground} Methode aufgerufen, falls
     * ein Fehler aufgetreten ist. Das Result der Methode wird daraufhin ignoriert und in der
     * delegate wird die {@link ws1415.common.task.ExtendedTaskDelegate#taskFailed} Methode
     * aufgerufen.
    ...
    /**
     * Wird aufgerufen wenn in der {@link ws1415.common.task.ExtendedTask#doInBackground} Methode
     * die {@link ws1415.common.task.ExtendedTask#publishProgress} Methode aufgerufen wird.
    ...
    /**
     * Wird aufgerufen wenn die {@link ws1415.common.task.ExtendedTask#doInBackground} Methode
