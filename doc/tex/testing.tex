...
Der Test läuft über die HoldTabsActivity der \glqq VeranstalterApp\grqq. Das hier angelegte Test Event wird an anderer Stelle in einem Test der User-App \KLASSE{ShowServeralEventsTest}  verifiziert und wird somit nach Beendigung des Tests nicht gelöscht.

\textbf{setUp():} Hier wird für den Nutzer das Google Konto ausgewählt zu Authentifizierung, zum „Veranstaltungen Erstellen“ Tab geswipt sowie die App gestartet.
