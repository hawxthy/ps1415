...
Um zu den eigentlichen Funktionen der Veranstalterapp zu gelangen muss man sich zu Beginn in der LoginActivity mit seinem Google-Account einloggen. Ist der Login erfolgreich, so wird die \KLASSE{HoldTabsActivity} gestartet.
